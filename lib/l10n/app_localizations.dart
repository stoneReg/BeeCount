...
abstract class AppLocalizations {
  ...
  /// No description provided for @aiReasoningVendorTitle.
  ///
  /// In en, this message translates to:
  /// **'Reasoning vendor protocol'**
  String get aiReasoningVendorTitle;

  /// No description provided for @aiReasoningVendorVolcengine.
  ///
  /// In en, this message translates to:
  /// **'Volcengine / Doubao'**
  String get aiReasoningVendorVolcengine;

  /// No description provided for @aiReasoningVendorZhipu.
  ///
  /// In en, this message translates to:
  /// **'Zhipu GLM'**
  String get aiReasoningVendorZhipu;

  /// No description provided for @aiReasoningVendorOpenaiCompat.
  ///
  /// In en, this message translates to:
  /// **'OpenAI compatible (generic)'**
  String get aiReasoningVendorOpenaiCompat;

  /// No description provided for @aiReasoningVendorHint.
  ///
  /// In en, this message translates to:
  /// **'Choose the vendor protocol for deep reasoning. Applies to text chat, image understanding, and multimodal voice (chat/completions). Many users route through proxy APIs, so the app cannot infer the vendor from the base URL.'**
  String get aiReasoningVendorHint;

  /// No description provided for @aiReasoningVendorRequired.
  ///
  /// In en, this message translates to:
  /// **'Select a vendor protocol before enabling deep reasoning'**
  String get aiReasoningVendorRequired;

  /// No description provided for @aiReasoningPickVendorBelow.
  ///
  /// In en, this message translates to:
  /// **'Select a reasoning vendor protocol below'**
  String get aiReasoningPickVendorBelow;

  /// No description provided for @aiReasoningPickLevelAbove.
  ///
  /// In en, this message translates to:
  /// **'Vendor selected — now choose a reasoning level (Low / Medium / High)'**
  String get aiReasoningPickLevelAbove;
